package com.br.salesbuddy.view.activity.menu;
...
import com.br.salesbuddy.presenter.menu.MenuPresenter;
import com.br.salesbuddy.view.activity.auth.AuthenticationActivity;
import com.br.salesbuddy.view.activity.home.HomeActivity;
...
public class MenuBottomSheetActivity extends DialogFragment implements MenuContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        presenter = new MenuPresenter(this, requireContext());
    }
